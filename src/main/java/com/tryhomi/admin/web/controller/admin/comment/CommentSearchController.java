...
import com.tryhomi.admin.web.support.ControllerUtils;
...
public class CommentSearchController {
    ...
    public String search(
        ...
        model.addAttribute("pagination", new com.tryhomi.admin.web.support.Pagination<>(comments, servletRequest));
